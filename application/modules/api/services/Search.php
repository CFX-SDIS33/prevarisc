...
class Api_Service_Search
{
     ...
     * @param float $lat
     * @param int $parent
     * @param int $count Par défaut 100, max 1000
     * @param int $page par défaut = 1
     * @return string
     */
    public function etablissements($label = null, $identifiant = null, $genres = null, $categories = null, $classes = null, $familles = null, $types_activites = null, $avis_favorable = null, $statuts = null, $local_sommeil = null, $lon = null, $lat = null, $parent = null, $commissions = null, $groupements_territoriaux = null, $count = 100, $page = 1)
    {
